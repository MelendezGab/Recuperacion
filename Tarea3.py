...
def cargar_consultas():
    doc_consultas = nltk.Text(nltk.regexp_tokenize(open("/Users/gabriel/Documents/INAOE/2do Cuatrimestre/Recuperacion/corpus/cacm/query.text","r").read(), "[A-za-z'.]+"))
    consultas=[]
    consulta=[]
    flag = 0
